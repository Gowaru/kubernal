...
describe('deploymentService', () => {
  ...
  describe('transitionStatus', () => {
    ...
    it('throws NotFoundError for missing deployment', async () => {
      ...
      await expect(deploymentService.transitionStatus('missing', 'building')).rejects.toThrow(
        NotFoundError,
      );
    });
    ...
    it('throws InvalidTransitionError for invalid status transition', async () => {
      ...
      await expect(deploymentService.transitionStatus('d1', 'healthy')).rejects.toThrow(
  ...
  describe('approve', () => {
    ...
    it('throws InvalidTransitionError when approving non-pending deployment', async () => {
      ...
      await expect(deploymentService.approve('d1', 'user-1')).rejects.toThrow(
        InvalidTransitionError,
      );
    });
  });
  ...
  describe('recordViolations', () => {
    ...
    it('throws NotFoundError for missing deployment', async () => {
      ...
      await expect(deploymentService.recordViolations('missing', [])).rejects.toThrow(
        NotFoundError,
      );
    });
  });
