...
import { notificationController } from '../../../modules/user/notification.controller.js';
...
} from '../../../modules/webhook-outbound/webhook-outbound.schema.js';
import { createApiKeySchema } from '../../../modules/api-key/api-key.schema.js';
...
export function createRouter(): Router {
  ...
  router.get(
    ...
    requireAuth(),
    notificationController.getMyPrefs,
  );
  router.patch(
    '/users/me/notification-preferences',
    requireAuth(),
    notificationController.updateMyPrefs,
  );
  ...
  router.post(
    ...
    requireAuth(),
    requireRole('developer'),
    validate(bumpVersionSchema),
    deploymentController.previewNextVersion,
  );
  ...
  router.get(
    '/deployments/:id/vulnerabilities',
    requireAuth(),
    deploymentController.getVulnerabilities,
  );
  ...
  router.post(
    '/kubernetes/argo/sync',
    requireAuth(),
    requireRole('developer'),
    validate(syncArgoSchema),
    kubernetesController.syncArgo,
  );
  router.patch(
    '/kubernetes/argo/auto-sync',
    requireAuth(),
    requireRole('platform_engineer'),
    validate(setAutoSyncSchema),
    kubernetesController.setAutoSync,
  );
  router.get('/kubernetes/hpa', requireAuth(), kubernetesController.listHPA);
  router.get('/kubernetes/hpa/all', requireAuth(), kubernetesController.listAllHPA);
  ...
  router.delete(
    ...
    requireAuth(),
    requireRole('platform_engineer'),
    kubernetesController.deleteDeployment,
  );
  router.post(
  ...
  router.get(
    ...
    requireAuth(),
    webhookOutboundController.listConfigs,
  );
  ...
  router.post(
    ...
    webhookOutboundController.createConfig,
  );
  router.patch(
    ...
    webhookOutboundController.updateConfig,
  );
  router.delete(
    '/webhooks-outbound/:id',
    requireAuth(),
    requireRole('developer'),
    webhookOutboundController.deleteConfig,
  );
  router.post(
    '/webhooks-outbound/:id/test',
    requireAuth(),
    requireRole('developer'),
    webhookOutboundController.testConfig,
  );
  router.get(
    '/webhooks-outbound/:configId/deliveries',
    requireAuth(),
    webhookOutboundController.listDeliveries,
  );
  ...
  router.post('/api-keys', requireAuth(), validate(createApiKeySchema), apiKeyController.create);
  router.delete('/api-keys/:id', requireAuth(), requireRole('developer'), apiKeyController.delete);
