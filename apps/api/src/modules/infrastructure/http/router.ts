...
import { createTemplateSchema, updateTemplateSchema } from "../../../modules/template/template.schema.js";
import { createApplicationSchema, updateApplicationSchema } from "../../../modules/application/application.schema.js";
import { createEnvironmentSchema, updateEnvironmentSchema } from "../../../modules/environment/environment.schema.js";
...
import { createPipelineSchema, updatePipelineStatusSchema } from "../../../modules/pipeline/pipeline.schema.js";
...
export function createRouter(): Router {
  ...
  router.patch("/applications/:id", validate(updateApplicationSchema), applicationController.update);
  ...
  router.patch("/environments/:id", validate(updateEnvironmentSchema), environmentController.update);
  ...
  router.post("/deployments/:id/transition", validate(transitionStatusSchema), deploymentController.transitionStatus);
  router.post("/deployments/:id/approve", validate(approveDeploymentSchema), deploymentController.approve);
  router.post("/deployments/:id/violations", validate(recordViolationsSchema), deploymentController.recordViolations);
  ...
  router.post("/pipelines/:id/status", validate(updatePipelineStatusSchema), pipelineController.updateStatus);
